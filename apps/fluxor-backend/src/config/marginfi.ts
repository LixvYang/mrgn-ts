...
const environment = env.NEXT_PUBLIC_MARGINFI_ENVIRONMENT;
const groupOverride = env.NEXT_PUBLIC_MARGINFI_GROUP_OVERRIDE;
const programOverride = env.NEXT_PUBLIC_MARGINFI_PROGRAM_OVERRIDE;
