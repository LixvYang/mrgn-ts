        ...
        >
          ...
          <div className="bg-background/60 py-3 px-4 rounded-lg">
            <dl className="grid grid-cols-2 gap-y-0.5">
              ...
              {isEmodeActive ? (
                <>
                  <dt className="text-muted-foreground">{isInLendingMode ? "权重" : "e-mode boost"}</dt>
                  <dd className="text-right text-white">
              ...
              {(!isEmodeActive || !isInLendingMode) && (
                <>
                  <dt className="text-muted-foreground">{isInLendingMode ? "权重" : "LTV"}</dt>
              ...
              <dt className="text-muted-foreground">数额</dt>
              <dd className="text-right text-white">
              ...
              <dt className="text-muted-foreground">USD 价值</dt>
              ...
              <dt className="text-muted-foreground">当前价格</dt>
              ...
              {bank.position.liquidationPrice && (
                <>
                  ...
                  <dt className="text-muted-foreground">清算价格</dt>
                  <dd
                    className={cn(
