  ...
  const stats = React.useMemo(
    () => [
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="bottom">
                <p>您无法借出原生质押。存入您的原生质押以增加您的借款容量。</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        ) : (
      ...
      },
      {
        title: "抵押品权重",
        description: "银行的权重",
        tooltip: "计入您抵押品的资产价值百分比。更高的权重意味着该资产的借款能力更强。",
        value:
      ...
      {
        title: "借款价值比",
        description: "银行的借款价值比",
        tooltip:
          "借款价值比（LTV）显示相对于您可用抵押品可以借出多少。更高的LTV意味着您可以借出更多，但也会增加清算风险。",
      ...
      },
      {
        ...
        tooltip: isNativeStakeBank
          ? "绿色显示您一年内存款将获得的收益。包含复利。"
          : "绿色显示您一年内存款将获得的收益。黄色显示您一年内借款将支付的费用。两者都包含复利。",
        value: (
          ...
          <div className="flex flex-col items-center lg:w-1/2">
            ...
            <ul className="flex flex-col gap-2 items-start text-foreground mt-6 translate-x-8">
              <li className="flex items-center gap-1">
                <span className="text-muted-foreground w-10">价格:</span>
                <Skeleton className="h-4 w-16" />
              </li>
              <li className="flex items-center justify-center gap-1">
                <span className="text-muted-foreground w-10">银行:</span>
                <Skeleton className="h-4 w-32" />
              </li>
              <li className="flex items-center justify-center gap-1">
                <span className="text-muted-foreground w-10">代币:</span>
                <Skeleton className="h-4 w-32" />
              </li>
            </ul>
          </div>
      ...
      <header className="flex flex-col lg:flex-row items-center justify-between gap-8 pb-4 pt-4 md:pt-0 ">
        <div className="flex flex-col items-center lg:w-1/2">
          ...
          <ul className="flex flex-col gap-2 items-start text-foreground mt-6 translate-x-8">
            ...
            <li className="flex items-center justify-center gap-1">
              <span className="text-muted-foreground w-10">银行:</span> <AddressActions address={bank.address} />
            </li>
            <li className="flex items-center justify-center gap-1">
              <span className="text-muted-foreground w-10">代币:</span>{" "}
